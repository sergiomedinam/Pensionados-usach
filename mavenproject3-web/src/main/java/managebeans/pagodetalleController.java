...
import sessionsbeans.pagodetalleFacadeLocal;
...
@Named("pagodetalleController")
@SessionScoped
public class pagodetalleController implements Serializable {

    @EJB
    private pagodetalleFacadeLocal ejbFacade;
    ...
    private pagodetalleFacadeLocal getFacade() {
        return ejbFacade;
    }
    ...
    public pagodetalle getpagodetalle(java.lang.Long id) {
    ...
    public static class pagodetalleControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            return controller.getpagodetalle(getKey(value));
        }
