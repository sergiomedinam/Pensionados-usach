...
import sessionsbeans.medicamentoFacadeLocal;
...
public class medicamentoController implements Serializable {
    ...
    public medicamento prepareCreate() {
        selected = new medicamento();
    ...
    public medicamento getmedicamento(java.lang.Long id) {
        return getFacade().find(id);
    }

    public List<medicamento> getItemsAvailableSelectMany() {
        return getFacade().findAll();
    }

    public List<medicamento> getItemsAvailableSelectOne() {
        return getFacade().findAll();
    }
    ...
    public static class medicamentoControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            return controller.getmedicamento(getKey(value));
        }
