...
import sessionsbeans.parametrosFacadeLocal;
...
public class parametrosController implements Serializable {
    ...
    @EJB
    private parametrosFacadeLocal ejbFacade;
    ...
    private parametrosFacadeLocal getFacade() {
        return ejbFacade;
    }
    ...
    public parametros getparametros(java.lang.Long id) {
